  ...
  return (
    <>
      <div className="overflow-x-clip min-h-[calc(100svh-40*var(--spacing))] flex flex-col justify-center gap-16 py-16">
        <LayoutComponent className="relative">
          ...
          <div className="text-center w-4/5 lg:w-3/5 mx-auto z-2 relative">
            ...
            <p className="font-normal text-base-content/65 text-lg lg:text-2xl mt-10">
      ...
      <div className=" animate-bounce">
        <Sticker className="w-8 h-8 mx-auto mb-2 text-base-content/65" />
        <ArrowBigDownDash className="w-6 h-6 mx-auto text-base-content/65 animate-bounce" />
      </div>
    </>
  )
}
