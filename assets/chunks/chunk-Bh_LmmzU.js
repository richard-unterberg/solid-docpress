const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/entries/pages_-docs-_-config-_error.wjC__1tB.js","assets/chunks/chunk-BBufqsCj.js","assets/chunks/chunk-BHnu8lAE.js","assets/static/components_css_tailwind-80b22bf9.Dt-UCe4r.css","assets/chunks/chunk-F9TpmR8N.js","assets/entries/pages_index.CloTaSq1.js","assets/entries/pages_-docs-_-config-.CXr-SbH6.js"])))=>i.map(i=>d[i]);
import{t as S,j as h,a as n,b as r,E as D,F as u,h as _,z as H,o as w,G as ie,H as ae,I as re,J as se,K as oe,M as le,N as de,f as F,O as ce,P as he,Q as pe,S as ue,s as G,A as $,T as W,U as ge,W as X,X as ke,Y as fe,Z as me,_ as P,$ as ye,a0 as be,a1 as ve,a2 as Be,a3 as Ee,a4 as Ae,a5 as we,a6 as Ce,a7 as Se}from"./chunk-BHnu8lAE.js";const m=({type:t="info",heading:e,children:i})=>h.jsxs(Fe,{$variant:t,children:[e&&h.jsx(xe,{children:e}),i]}),Fe=S.section.variants({base:`
    p-4
    mb-5
    border
    rounded-lg
    ...
    prose-div:my-0!
    text-sm
  `,variants:{$variant:{info:"bg-info/5 border-info/30",warning:"bg-warning/5 border-warning/30",error:"bg-error/5 border-error/25",success:"bg-success/5 border-success/35"}},defaultVariants:{$variant:"info"}}),xe=S.header`
  mt-1
  font-bold
  text-base
  mb-5
`,b=({size:t="md",data:e})=>h.jsxs(Te,{$size:t,children:[h.jsx("thead",{className:"bg-base-200 rounded-t-box overflow-hidden",children:h.jsx("tr",{children:e.headers.map((i,a)=>h.jsx("th",{children:i},a))})}),h.jsx("tbody",{children:e.rows.map((i,a)=>h.jsx("tr",{children:i.map((s,o)=>h.jsx("td",{children:s},o))},a))})]}),Te=S.table.variants({base:`
    not-prose
    table
    w-full
    table-zebra
