import { ProseContainer } from '@unterberg/docsengine/client'

const StartPageFooter = () => {
  return (
    <ProseContainer>
      {/* <div className="flex flex-col">
        <blockquote className='text-lg font-mono text-primary'><i>Premature optimization is the root of all evil.</i></blockquote>
